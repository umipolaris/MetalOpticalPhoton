...
s:Sc/U1v5_T/OutputFile = "U1v5_gpu_th{th}_T_sf1"
...
s:Sc/U1v5_R/OutputFile = "U1v5_gpu_th{th}_R_sf1"
...
def main():
    print(f"Generating + running {len(ANGLES)*len(MODES)} U1v5 jobs (modes={MODES}) ...")
